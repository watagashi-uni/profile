    ...
    v-list-item(dense, :to="`/user/${user.userId || (user.userProfile && user.userProfile.userId)}`")
      ...
      v-list-item-content
        ...
        v-list-item-subtitle.d-flex
          Honor.pr-2(:id="user.userProfile.honorId1", :level="user.userProfile.honorLevel1", size=24)
          Honor.pr-2(:id="user.userProfile.honorId2", :level="user.userProfile.honorLevel2", size=24, type="sub")
          Honor.pr-2(:id="user.userProfile.honorId3", :level="user.userProfile.honorLevel3", size=24, type="sub")
      ...
      v-list-item-action(v-else-if="user.score!==false")
